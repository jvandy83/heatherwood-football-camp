...
| `REGISTRATION_OPEN` | Set to `true` or `1` to accept new registrations and payments. When unset, registration is closed (form, pay links, and payment reminders are disabled). |
| `REGISTRATION_CLOSED_MESSAGE` | Optional custom message shown when registration is closed. |
